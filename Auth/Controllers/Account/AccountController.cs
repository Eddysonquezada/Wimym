...
namespace Auth.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                var seoUrl = $"{model.Name + model.Lastname}".Sluglify();

                var total = await _context.Users.Where(x => x.SeoUrl.Contains(seoUrl)).CountAsync();
                ...
                ModelState.AddModelError("User", "No se pudo crear un nuevo usuario");
            }
