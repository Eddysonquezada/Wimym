...
namespace Wimym.Backend.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        private CurrencyModels currencyModels;
        ...
        {
            return currencyModels.FilterData(pageNum, filterValue, order);
        }

        public List<Currency> GetCurrencies(int id)
        {
            return currencyModels.GetCurrencies(id);
        }
        ...
        {
            return currencyModels.SaveCurrency(code, name, state);
        }
