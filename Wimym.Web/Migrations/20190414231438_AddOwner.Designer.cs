...
namespace Wimym.Web.Migrations
{
    ...
    [Migration("20190414231438_AddOwner")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wimym.Web.Data.Entities.Owner", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Wimym.Web.Data.Entities.ApplicationUser", b =>
                {
                    b.HasOne("Wimym.Web.Data.Entities.Owner", "Owner")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Wimym.Web.Data.Entities.Wallet", b =>
                {
                    b.HasOne("Wimym.Web.Data.Entities.ApplicationUser", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Wimym.Web.Data.Entities.ApplicationUser", "DeletedUser")
                        .WithMany()
                    ...
                    b.HasOne("Wimym.Web.Data.Entities.ApplicationUser", "UpdatedUser")
                        .WithMany()
